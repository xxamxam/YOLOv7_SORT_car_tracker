...
from yolov7.utils.datasets import letterbox, np
from yolov7.utils.general import check_img_size, non_max_suppression, apply_classifier,scale_coords, xyxy2xywh
from yolov7.utils.plots import plot_one_box
from yolov7.utils.torch_utils import select_device, load_classifier,TracedModel


class Detector:
    def __init__(self, conf_thres:float = 0.25, iou_thresh:float = 0.45, agnostic_nms:bool = False, save_conf:bool = False, classes:list = None, use_gpu :bool = True):
        '''
        args:
        ...
        '''
        self.device = select_device("cuda" if torch.cuda.is_available() and use_gpu else 'cpu')
    ...
    def load_model(self, weights:str = "weights/car/best-tiny-200.pt", img_size:int = 640, trace:bool = True, classify:bool = False):
        '''
